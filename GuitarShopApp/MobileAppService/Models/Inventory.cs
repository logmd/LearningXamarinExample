    ...
    public static class Inventory
    {
        public static IEnumerable<Feature> GetAllFeatures()
        {
            return new List<Feature>
                    {
                        new Feature { InventoryItemId = "1", Text = "Wizard-7 5pc Maple/Walnut neck w/KTS™ TITANIUM rods" },
                        new Feature { InventoryItemId = "1", Text = "American Basswood body" },
                        new Feature { InventoryItemId = "1", Text = "Jumbo frets w/Premium fret edge treatment"},
                        new Feature { InventoryItemId = "1", Text = "Rosewood fretboard w/Green dot inlay"},
                        new Feature { InventoryItemId = "1", Text = "Edge-Zero II bridge"},
                        new Feature { InventoryItemId = "1", Text = "Cosmo black hardware"},
                        new Feature { InventoryItemId = "1", Text = "DiMarzio® Blaze™ pus"},
                        new Feature { InventoryItemId = "1", Text = "Hardshell case included"},
                        new Feature { InventoryItemId = "2", Text = "Neck type:  Nitro Wizard 3pc Maple/Bubinga neck"},
                        new Feature { InventoryItemId = "2", Text = "Body:  Rosewood top/Layered Ash body"},
                        new Feature { InventoryItemId = "2", Text = "Fretboard:  Birdseye Maple fretboard"},
                        new Feature { InventoryItemId = "2", Text = "Fret:  Jumbo frets"},
                        new Feature { InventoryItemId = "2", Text = "Bridge:  Gibraltar Standard II bridge"},
                        new Feature { InventoryItemId = "2", Text = "Neck pickup:  DiMarzio® Fusion Edge (H) neck pickup"},
                        new Feature { InventoryItemId = "2", Text = "Bridge pickup:  DiMarzio® Fusion Edge (H) bridge pickup"},
                        new Feature { InventoryItemId = "2", Text = "Tuners:  Gotoh Locking"},
                        new Feature { InventoryItemId = "2", Text = "Hardware color:  Black"},
                        new Feature { InventoryItemId = "2", Text = "Factory tuning:  1D, 2A, 3F, 4C, 5G, 6D"},
            };
        }

        public static IEnumerable<InventoryItem> GetAllProducts()
        {
